...
Proper attack labeling based on filenames
"""
...
class CICIDS2017AcademicEvaluator:
    ...
    def __init__(self, cicids2017_path: str = "./cicids2017/", output_path: str = "./results/"):
        ...
        # CICIDS2017 file mapping with proper attack labels
        self.cicids2017_files = {
            ...
            'Portscan-Friday-no-metadata.parquet': 'PORT_SCAN',
    ...
    def load_cicids2017_data(self, file_path: str, attack_type: str, sample_size: int = 10000):
        """Load CICIDS2017 data from parquet file with proper attack labeling"""
...
def main():
    ...
    # Create evaluator
    evaluator = CICIDS2017AcademicEvaluator(args.cicids2017_path, args.output)
